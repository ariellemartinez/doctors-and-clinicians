...
datasets = [
	{
		...
		# "dataset_link": "https://data.cms.gov/provider-data/dataset/mj5m-pzi6",
...
for dataset in datasets:
	try:
		...
		for zip_code in three_digit_zip_codes:
			...
			offset = 0
			initial_payload = "limit=" + str(limit) + "&offset=" + str(offset) + "&count=true&results=true&schema=true&keys=true&format=json&rowIds=false&conditions%5B0%5D%5Bproperty%5D=st&conditions%5B0%5D%5Boperator%5D=%3D&conditions%5B0%5D%5Bvalue%5D=NY&conditions%5B1%5D%5Bproperty%5D=zip&conditions%5B1%5D%5Boperator%5D=LIKE&conditions%5B1%5D%5Bvalue%5D=" + zip_code + "%25"
